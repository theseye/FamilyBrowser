...
namespace FamilyBrowser
{
    class LoadFamily : IExternalEventHandler
    {
        ...
        {
            var fileName = Path.Combine(Path.GetTempPath(), "Bimcc", Family_browser.symbol_name) + ".rfa";
            ...
            Family Family = new FilteredElementCollector(doc).OfClass(typeof(Family)).FirstOrDefault(e => e.Name.Equals(Family_browser.symbol_name)) as Family;
